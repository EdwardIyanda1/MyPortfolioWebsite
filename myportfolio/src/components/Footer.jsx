      ...
      <div className="container mx-auto px-6">
        ...
        <div className="flex flex-col md:flex-row justify-between items-end mb-24 gap-8">
          ...
          <div className="flex flex-col space-y-4 text-right">
            ...
            <a href="https://x.com/edwardd_iyanda" target="_blank" rel="noreferrer" className="text-zinc-500 hover:text-white text-sm tracking-widest uppercase transition-colors">X (ex Twitter)</a>
          </div>
        </div>
